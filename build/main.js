...
/***/ "./src/scripts/animations/flagAnimation.js":
/*!*************************************************!*\
  !*** ./src/scripts/animations/flagAnimation.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initFlagAnimation: () => (/* binding */ initFlagAnimation)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");

var initFlagAnimation = function initFlagAnimation() {
  var flagItems = document.querySelectorAll(".flag-text__item");
  if (flagItems.length === 0) return;
  var flagTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    repeat: -1,
    repeatDelay: 2
  });
  flagTl.to(".flag-text__item--black", {
    duration: 0.7,
    brightness: 1.2,
    scale: 1.05,
    ease: "power2.inOut"
...
/***/ "./src/scripts/animations/scrollAnimations.js":
/*!****************************************************!*\
  !*** ./src/scripts/animations/scrollAnimations.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initScrollAnimations = function initScrollAnimations() {
  ...
  var titleElements = document.querySelectorAll("[data-animation='stagger']");
  titleElements.forEach(function (element) {
    var splitText = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText(element, {
      type: "chars,words",
      linesClass: "line",
      charsClass: "char",
      wordsClass: "word"
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(splitText.chars, {
      opacity: 0,
      y: 20,
      rotationX: -90,
  ...
  titleElements.forEach(function (title) {
    var splitTitle = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText(title, {
      type: "chars,words"
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(splitTitle.chars, {
      opacity: 0,
      y: 20
    }, {
      opacity: 1,
  ...
  var fadeElements = document.querySelectorAll("[data-animation='fade-in']");
  ...
  var projectCards = document.querySelectorAll(".card--secondary");
  if (projectCards.length > 0) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(projectCards, {
      opacity: 0,
      y: 30
    }, {
      opacity: 1,
  ...
  var timelineCards = document.querySelectorAll(".timeline__item");
  if (timelineCards.length > 0) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(timelineCards, {
      opacity: 0,
      x: -50
    }, {
      opacity: 1,
  ...
  var aboutParagraphs = document.querySelectorAll("section p:not([data-animation])");
  if (aboutParagraphs.length > 0) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(aboutParagraphs, {
      opacity: 0,
      y: 20
    }, {
      opacity: 1,
